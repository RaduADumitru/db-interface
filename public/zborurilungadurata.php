...
$sql = "select z.nr_zbor, concat(floor(avg((timestampdiff(minute, z.plecare_dus, z.sosire_dus)
    + timestampdiff(minute, z.plecare_intors, z.sosire_intors)) / 2) / 60), 'h ',
  lpad(floor(avg(timestampdiff(minute, z.plecare_dus, z.sosire_dus)) % 60) , 2, 0), 'min') as durata_medie_zbor
from zbor z
group by z.nr_zbor
